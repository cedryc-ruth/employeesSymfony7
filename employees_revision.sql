...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 21 fév. 2024 à 21:51
...
--
-- Base de données : `employees_revision`
--
...
--
-- Structure de la table `emp_project`
--
...
--
-- Déchargement des données de la table `emp_project`
--

INSERT INTO `emp_project` (`id`, `project_id`, `emp_no`) VALUES
(2, 1, 10004),
(3, 2, 10002),
(4, 1, 10006),
(10, 2, 10001),
...
CREATE TABLE `members` (
  ...
  `group_code` char(4) DEFAULT NULL,
...
(10003, '1959-12-03', 'Parto', 'Bamford', NULL, 'M', NULL, '', '1986-08-28', '', '[\"ROLE_USER\"]', 0),
(10004, '1954-05-01', 'Chirstian', 'Koblick', 'B2', 'M', NULL, '', '1986-12-01', '', '[\"ROLE_USER\"]', 0),
(10005, '1955-01-21', 'Kyoichi', 'Maliniak', 'B2', 'M', NULL, '', '1989-09-12', '', '[\"ROLE_USER\"]', 0),
(10006, '1953-04-20', 'Anneke', 'Preusig', NULL, 'F', NULL, '', '1989-06-02', '', '[\"ROLE_USER\"]', 0),
(10007, '1957-05-23', 'Tzvetan', 'Zielinski', 'G3', 'F', NULL, '', '1989-02-10', '', '[\"ROLE_USER\"]', 0),
(10008, '1958-02-19', 'Saniya', 'Kalloufi', 'A1', 'M', NULL, '', '1994-09-15', '', '[\"ROLE_USER\"]', 0),
(10009, '1952-04-19', 'Sumant', 'Peac', 'A1', 'F', NULL, '', '1985-02-18', '', '[\"ROLE_USER\"]', 0),
...
INSERT INTO `projects` (`id`, `name`, `leader`) VALUES
(1, 'Mars', 10006),
(2, 'Jupiter', 10001),
(3, 'Mercure', NULL);
...
--
-- Index pour la table `emp_project`
--
...
--
-- AUTO_INCREMENT pour la table `emp_project`
--
ALTER TABLE `emp_project`
...
--
-- Contraintes pour la table `emp_project`
--
ALTER TABLE `emp_project`
  ADD CONSTRAINT `emp_project_ibfk_1` FOREIGN KEY (`emp_no`) REFERENCES `members` (`emp_no`) ON UPDATE CASCADE,
  ADD CONSTRAINT `emp_project_ibfk_2` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON UPDATE CASCADE;
...
--
ALTER TABLE `members`
  ADD CONSTRAINT `members_ibfk_1` FOREIGN KEY (`group_code`) REFERENCES `groups` (`code`) ON UPDATE CASCADE;

--
-- Contraintes pour la table `projects`
--
ALTER TABLE `projects`
  ADD CONSTRAINT `projects_ibfk_1` FOREIGN KEY (`leader`) REFERENCES `members` (`emp_no`) ON DELETE SET NULL ON UPDATE CASCADE;
